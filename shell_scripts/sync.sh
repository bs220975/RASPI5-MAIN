...
function upload_specific() {
    ...
    # Mirror the full relative path on Drive so paths stay consistent with
    # options 1 and 2.  e.g. Git_projects/RASPI5-MAIN locally →
    # gdrive:/pi5_drive/Git_projects/RASPI5-MAIN on Drive.
