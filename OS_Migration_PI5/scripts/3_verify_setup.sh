#!/bin/bash
# =============================================================
# POST-INSTALL VERIFICATION SCRIPT — Raspberry Pi 5
...
echo -e "${CYAN}============================================${NC}"
echo -e "${CYAN}   Pi5 64-bit Setup Verification${NC}"
echo -e "${CYAN}============================================${NC}"
echo ""
...
# Log folder
check "logs folder exists"           "[ -d /home/pi5/pi5_drive/Git_projects/RASPI5-MAIN/logs ]"
# Script paths the services depend on
check "mybot script exists"          "[ -f /home/pi5/pi5_drive/Git_projects/RASPI5-MAIN/main.py ]"
check "influx script exists"         "[ -f /home/pi5/pi5_drive/Git_projects/RASPI5-MAIN/influx_aws_publish/influxdb2_aws_publish.py ]"
echo ""
...
CERT_DIR="/home/pi5/pi5_drive/Git_projects/RASPI5-MAIN/aws_certs"
